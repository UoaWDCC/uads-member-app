...
function attach(toolbox) {
    ...
    function generate(opts) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var template, target, props, data, directory, pathToTemplate, templateContent, content, dir, dest;
            return __generator(this, function (_a) {
                ...
                ramda_1.forEach(function (x) {
                    data[x] = string_tools_1.strings[x];
                }, ramda_1.keys(string_tools_1.strings));
                directory = opts.directory ? opts.directory : (plugin && plugin.directory) + "/templates";
