...
function findCommand(runtime, parameters) {
    ...
    var targetCommand = runtime.defaultCommand;
    ...
    commandPath.forEach(function (currName) {
        ...
        var segmentCommand = runtime.commands
            ...
            .sort(sortCommands)
            .find(function (command) { return ramda_1.equals(command.commandPath.slice(0, -1), resolvedPath) && command.matchesAlias(currName); });
        if (segmentCommand) {
