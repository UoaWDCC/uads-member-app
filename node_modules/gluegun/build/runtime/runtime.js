...
var Runtime = /** @class */ (function () {
    ...
    Runtime.prototype.addCoreExtensions = function (exclude) {
        ...
        coreExtensions.filter(function (ex) { return !exclude.includes(ex); }).forEach(function (ex) {
    ...
    Runtime.prototype.addCommand = function (command) {
        ...
        var newCommand = ramda_1.is(command_1.Command, command) ? command : command_loader_1.loadCommandFromPreload(command);
    ...
    Runtime.prototype.addDefaultPlugin = function (directory, options) {
        ...
        var config = config_loader_1.loadConfig(this.brand, directory) || {};
        this.defaults = config.defaults;
        this.config = ramda_1.dissoc('defaults', config);
        return this;
    };
    /**
    ...
    Runtime.prototype.addPlugins = function (directory, options) {
        ...
        return subdirs.map(function (dir) { return _this.addPlugin(dir, ramda_1.dissoc('matching', options)); });
    };
    return Runtime;
}());
